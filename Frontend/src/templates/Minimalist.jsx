  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center mt-15 mb-20">
        ...
        <h1 className="text-black text-3xl font-mono mt-4">Your Name</h1>
        <h1 className="text-black text-2xl font-serif mt-4">Profession</h1>
        <div className="flex flex-rows gap-40 items-center mt-10">
          <span className="hover:text-blue-500 cursor-pointer">
            <svg className="w-5 h-5 inline-block mr-2 text-gray-600" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="flex flex-col bg-[#f9fbfc] min-w-[1000px] items-start mt-10 pb-25 border-1 border-gray-300">
          ...
          <div className="flex items-center ml-70 mb-3 mt-25">
            ...
            <div className="border-2 w-[1000px] min-h-[100px] rounded-2xl ml-70 mt-13 p-4">
              <span className="text-xl p-5">User Info Here...</span>
            </div> 
          ...
          <div className="flex items-center ml-70 mb-2 mt-20">
            ...
            <div className="border-2 w-[1000px] min-h-[100px] rounded-2xl ml-70 mt-13 p-4">
              <span className="text-xl p-5">User Skills Here...</span>
            </div>
          ...
          <div className="flex items-center ml-70 mb-2 mt-20">
            ...
            <div className="border-2 w-[1000px] min-h-[100px] rounded-2xl ml-70 mt-13 p-4">
              <span className="text-xl p-5">User Projects Here...</span>
            </div>
        </div>
      </div>
