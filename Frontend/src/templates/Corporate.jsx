          ...
          <div className="bg-blue-500 text-white rounded-xl shadow-lg p-6 w-80">
            ...
            <ol className="space-y-2 text-sm">
              <li className="flex items-center">
                ...
                <h2 className=" text-lg">m@gmail.com</h2>
              </li>
              <li className="flex items-center">
                <PhoneIcon className="inline-block w-5 h-5 mr-2" />
                <h2 className=" text-lg">+91 9876543210</h2>
              </li>
              <li className="flex items-center">
                <MapPinIcon className="inline-block w-5 h-5 mr-2" />
                <h2 className=" text-lg">Mumbai, India</h2>
              </li>
              <li className="flex items-center">
                <svg
            ...
            <div>
              <div className="flex flex-col p-4  mt-8 shadow-lg ml-8 mr-8 rounded-2xl">
                ...
                <h3 className="p-4 text-lg">
                  ...
                  quam incidunt blanditiis debitis recusandae doloribus
                  architecto in enim facere eaque! Iure expedita harum explicabo
                  labore. Quis repellendus incidunt laudantium id!
                </h3>
              </div>
            </div>
            ...
            <div className=" flex flex-col w-[500px]">
              ...
              <div className="flex flex-col p-4  mt-8 shadow-lg ml-8 mr-8 rounded-2xl">
                ...
                <ol className="flex flex-col w-auto list-disc ml-8 [&>li::marker]:text-blue-300">
                  ...
                  <li className=" p-3 rounded-2xl">Certified Java Developer</li>
                </ol>
              </div>
